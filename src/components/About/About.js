...
const About = (props) => {
  ...
  const desktopContent = (
    <AnimatedList pose={pose}>
      <Row className="align-items-center">
        ...
        <Col
          md={6}
          className="d-flex align-items-center justify-content-center aboutPortraitCol"
        >
          <Portrait source={photo} altText={WEBSITE_TEXT.about.altText} />
        </Col>
      </Row>
  ...
  const animationOffset = props.mobile ? "-200%" : "-500px";
  ...
  return (
    <React.Fragment>
      <div className="lightBackground sectionContent">
        <Container>
          <Row>
            <h1 id={SECTION_NAMES.main[0].id}>{SECTION_NAMES.main[0].name}</h1>
          </Row>
